...
import 'package:venuedashbusiness/routers/product_add_popular_item_page.dart';
...
class ProductPopularItemsPage extends StatelessWidget {
  const ProductPopularItemsPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            onTap: () {
              Get.to(() => const ProductAddPopularItemPage());
            },
            child: Image.asset(
                                  ...
                                  Flexible(
                                    child: Align(
                                        ...
                                        child: InkWell(
                                            onTap: () => {
                                                  Get.dialog(
                                                      CustomActionDialog(
                                                        ...
                                                        description: "Are you sure you want to remove this Product from Popular Items?",
                                                        onYesPressed: () {
                                                          Get.back();
                                                          Get.dialog(
                                                              CustomAlertConfirmationDialog(
                                                                dialogHeight: 240,
                                                                titleText: "Sucess!",
                                                                descText: "Product removed successfully.",
                                                                buttonText: "Okay",
                                            ...
                                            child: Image.asset("assets/graphics/ic_delete_icon_green.png"))),
                                  )
                                ],
                              ),
                            ),
